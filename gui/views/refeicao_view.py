"""
Refeicao View Module
Contains the view class for meal management screen.
"""
...
class RefeicaoView(ttk.Frame):
    """
    View for Meal (Refeicao) management.
    
    Provides CRUD operations:
        - Create: Form to add new meal
        - Read: List all meals
        - Update: Form to edit existing meal
