"""
Dieta View Module
Contains the view class for diet management screen.
"""
...
class DietaView(ttk.Frame):
    """
    View for Diet (Dieta) management.
    
    Provides CRUD operations:
        - Create: Form to add new diet
        - Read: List all diets
        - Update: Form to edit existing diet
