"""
Exercicio View Module
Contains the view class for exercise management screen.
"""
...
class ExercicioView(ttk.Frame):
    """
    View for Exercise (Exercicio) management.
    
    Provides CRUD operations:
        - Create: Form to add new exercise
        - Read: List all exercises
        - Update: Form to edit existing exercise
    ...
    def __init__(self, parent, api_client):
        """
        Constructor for ExercicioView.
        
        Args:
            parent: Parent widget
            api_client: ApiClient instance for API communication
        """
