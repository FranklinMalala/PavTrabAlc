"""
Exercicio Controller Module
Contains the controller for exercise operations.
"""
...
class ExercicioController:
    """
    Controller for Exercicio (Exercise) model.
    Handles business logic and validation for exercise operations.
    ...
    def create(self, data):
        ...
        Returns:
            tuple: (Exercicio instance, error message or None)
        """
        try:
            # Validate data
    ...
    def get_by_id(self, id):
        ...
        Returns:
            tuple: (Exercicio dictionary or None, error message or None)
        """
