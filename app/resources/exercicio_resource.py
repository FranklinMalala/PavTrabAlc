...
class ExercicioResource(Resource):
    ...
    def get(self, id):
        ...
        Returns:
            tuple: (exercise data or error, HTTP status code)
        """
    ...
    def put(self, id):
        ...
        Request body:
            {
                "tipo_exercicio": "string (optional)",
                "quantidade_repeticoes": "integer (optional)",
                "ciclos": "integer (optional, non-negative)",
                "pausa_entre_ciclos": "integer (optional)",
                "dieta_id": "integer (optional)"
            }
            
        Returns:
            tuple: (updated exercise or error, HTTP status code)
        """
        data = request.get_json()
