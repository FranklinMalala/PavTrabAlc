"""
Resources Package
Contains Flask-RESTful resource classes for API endpoints.
"""
...
__all__ = [
    'DietaResource', 'DietaListResource',
    'RefeicaoResource', 'RefeicaoListResource',
    'ExercicioResource', 'ExercicioListResource'
]
