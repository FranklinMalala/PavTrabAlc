"""
Dieta Model Module
Contains the Dieta (Diet) model class.
"""
...
class Dieta(BaseModel):
    """
    Dieta (Diet) Model.
    Represents a diet with its goal and description.
    
    Relationships:
        - One diet has many meals (1:N)
        - One diet has many exercises (1:N)
    
    Demonstrates:
        - Inheritance from BaseModel
        - Polymorphism (overriding to_dict method)
        - Encapsulation (methods for data access)
        - Bidirectional relationships with SQLAlchemy
    """
    ...
    def __init__(self, meta, descricao=None, **kwargs):
        """
        Constructor for Dieta model.
        
        Args:
            meta: Diet goal (required)
            descricao: Detailed description of the goal (optional)
    ...
    def to_dict(self, include_relations=False):
        ...
        Args:
            include_relations: Whether to include related meals and exercises
            
        Returns:
            dict: Dictionary representation of the diet
        """
        data = super().to_dict()
        data.update({
            'meta': self.meta,
    ...
    def add_refeicao(self, refeicao):
        """
        Add a meal to this diet.
        
        Args:
            refeicao: Refeicao instance to add
        """
    ...
    def add_exercicio(self, exercicio):
        """
        Add an exercise to this diet.
        
        Args:
            exercicio: Exercicio instance to add
        """
